...
@RestController
@RequestMapping("/api/v1/imports/retailers/EUROPROM/locations")
@ConditionalOnProperty(
        name = "price-import.http-endpoints.enabled",
        havingValue = "true",
        matchIfMissing = true
)
public class EuropromLocationImportController {

    private final EuropromLocationImportService importService;

    public EuropromLocationImportController(
            EuropromLocationImportService importService
    ) {
