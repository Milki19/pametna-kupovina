...
@RestController
@RequestMapping("/api/v1/imports/retailers/DIS/locations")
@ConditionalOnProperty(
        name = "price-import.http-endpoints.enabled",
        havingValue = "true",
        matchIfMissing = true
)
public class DisLocationImportController {

    private final DisLocationImportService importService;

    public DisLocationImportController(
            DisLocationImportService importService
    ) {
